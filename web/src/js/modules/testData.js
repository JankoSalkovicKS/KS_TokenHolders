...
const INCOME_TOKEN_AMOUNT = calculation.income;
const BASE_TOKEN_AMOUNT = calculation.base;
const OVERALL_TOKENS = BASE_TOKEN_AMOUNT + INCOME_TOKEN_AMOUNT;
